...
export const AUDIT_ACTION_LABELS: Record<string, string> = {
  ...
  'market.return.requested': 'Mahsulotni qaytarishni so\'radi',
  'market.return.approved': 'Qaytarishni tasdiqladi va pulni qaytardi',
  'market.return.rejected': 'Qaytarishni rad etdi',
  ...
  'taxi.ride.created': 'Taksi chaqirdi',
  'taxi.ride.cancelled': 'Taksini bekor qildi',
  'taxi.ride.accepted': 'Haydovchi buyurtmani oldi',
  'taxi.ride.completed': 'Safar yakunlandi',
  'taxi.driver.registered': "Haydovchi bo'lib ro'yxatdan o'tdi",
  'taxi.ride.alert': 'Safarda SOS bosildi',
  'taxi.driver.assigned': 'Haydovchi roli berildi',
  'taxi.driver.unassigned': 'Haydovchi roli olib tashlandi',
  ...
  'support.ticket.created': 'Murojaat ochdi',
  'support.ticket.answered': 'Murojaatga javob berdi',
  'support.ticket.closed': 'Murojaatni yakunladi',
};
...
export const AUDIT_GROUP_ACTIONS: Record<Exclude<AuditFilterGroup, 'ALL'>, readonly string[]> = {
  MONEY: [
    ...
    'market.return.requested',
    'market.return.approved',
    'market.return.rejected',
    ...
    'taxi.ride.accepted',
    'taxi.ride.completed',
    'taxi.driver.registered',
    'taxi.ride.alert',
    'taxi.driver.assigned',
    'taxi.driver.unassigned',
    'parcel.created',
    'parcel.cancelled',
